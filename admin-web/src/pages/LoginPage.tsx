        ...
        <Card className="login-card" bordered={false}>
          ...
          >
            ...
            <Form.Item label="管理员密码" name="password" rules={[{ required: true, message: "请输入管理员密码" }]}>
              <Input.Password prefix={<LockOutlined />} placeholder="本地默认 admin123456" autoComplete="current-password" />
            </Form.Item>
          ...
          <div className="node-bar">本地开发默认账号：admin · 默认密码：admin123456</div>
        </Card>
      </section>
    </main>
  );
